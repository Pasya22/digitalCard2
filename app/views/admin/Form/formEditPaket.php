                    ...
                    <div class="container-form">
                        <form action="<?= BASEURL . 'Admin/editPaket' ?>" method="POST">
                            ...
                            <div class="nama katalog">
                                ...
                                <input name="nama_paket" id="nama katalog" type="text" placeholder="Masukan nama paket" value="<?= $data['paket']['nama_paket'] ?>" required>
                            </div>
                            <div class="Kategori">
                                ...
                                <select name="kategori_id" id="kategori_id" required>
                                    ...
                                    <option value="<?= $data['paket']['paket_id'] ?>"><?= $data['kategoriId']['nama_kategori'] ?></option>
